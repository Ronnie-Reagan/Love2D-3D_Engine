...
struct AirspeedIndicatorSettings {
    InstrumentDialStyle style {
        true, 48.0f, 49.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, -6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 110, 228, 182 }, 255, { 255, 118, 96 }, 255
    };
    int maxKph = 320;
    int minorStepKph = 10;
    int majorStepKph = 20;
    ...
    float unitOffsetY = 6.0f;
};

struct AttitudeIndicatorSettings {
    InstrumentDialStyle style {
        true, 139.0f, 49.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, 6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 255, 214, 96 }, 255, { 255, 118, 96 }, 255
    };
    float pitchPixelsPerDegree = 1.0f;
    int ladderMinorStepDegrees = 5;
    int ladderMajorStepDegrees = 10;
    float maxDisplayedPitchDegrees = 28.0f;
    float bankSmoothing = 0.16f;
};

struct AltimeterSettings {
    InstrumentDialStyle style {
        true, 230.0f, 49.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, 6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 110, 228, 182 }, 255, { 255, 214, 96 }, 255
    };
    float digitRadiusScale = 0.55f;
...
struct TurnCoordinatorSettings {
    InstrumentDialStyle style {
        true, 48.0f, 141.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, 6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 255, 214, 96 }, 255, { 255, 118, 96 }, 255
    };
    float turnRateFullScaleDegreesPerSecond = 3.0f;
    float slipFullScaleDegrees = 10.0f;
    float needleTravel = 18.0f;
    float ballTravel = 12.0f;
};

struct HeadingIndicatorSettings {
    InstrumentDialStyle style {
        true, 139.0f, 141.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, 6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 255, 214, 96 }, 255, { 255, 118, 96 }, 255
    };
...
struct VerticalSpeedIndicatorSettings {
    InstrumentDialStyle style {
        true, 230.0f, 141.0f, 82.0f, 0.40f, 1.0f, 1.0f, 1.0f, 8.0f, 6.0f,
        { 8, 14, 22 }, 220, { 170, 210, 255 }, 228, { 230, 240, 255 }, 255,
        { 230, 240, 255 }, 255, { 110, 228, 182 }, 255, { 255, 118, 96 }, 255
    };
    int maxFpm = 3000;
...
struct HudSettings {
    ...
    int speedometerMaxKph = 320;
    int speedometerMinorStepKph = 10;
    int speedometerMajorStepKph = 20;
    int speedometerLabelStepKph = 40;
